...
<body>
	...
	<div class="container-fluid">
		<div class="row clearfix">
			<div class="col-sm-3 rightheight pull-right" style="padding: 0;">
				<div class="servicebg-right">
					<div class="bg">
						<a href="index.html"><img src="images/cross.png" ></a>
						<ul class="customtab-list" style="margin-top: 20px;">
							<li class="active"><a href="reviews_inner.html">Review</a></li>
							<li style="margin-top: 50px;"><a href="services.html">Services</a></li>
				...
				<div class="custom-tab leftheight">
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="tour-banner">
								<img src="images/inner-banners/reviews_final.jpg">
							</div>
						</div>
					</div>
					<div class="row" style="padding-bottom:50px;"> 
						<div class="col-sm-6">
							<div class="advisor-imagebg">
								...
								<div class="adviser-text">
									<h3>Reviews from Trip Advisor</h3>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.</p>
									<h4>-Anil S From Lucknow, India</h4>
								</div>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="advisor-imagebg">
								<div class="adviser-image">
									<img src="images/reviews/image02.jpg">
								</div>
								<div class="adviser-text">
									<h3>Reviews from Trip Advisor</h3>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.</p>
						...
						<div class="col-sm-6">
							<div class="advisor-imagebg">
								<div class="adviser-image">
									<img src="images/reviews/image03.jpg">
								</div>
								<div class="adviser-text">
									<h3>Reviews from Trip Advisor</h3>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.</p>
						...
						<div class="col-sm-6">
							<div class="advisor-imagebg">
								<div class="adviser-image">
									<img src="images/reviews/image04.jpg">
								</div>
								<div class="adviser-text">
									<h3>Reviews from Trip Advisor</h3>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.</p>
