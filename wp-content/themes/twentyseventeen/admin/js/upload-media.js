jQuery(document).ready(function ($) {
    function media_upload(button_class) {
        ...
        $('body').on('click', button_class, function (e) {
            var i = $(this).attr("data-holder-id");
            ...
            wp.media.editor.send.attachment = function (props, attachment) {
                ...
                if (_custom_media) {
                    ...
                    var imageinput = "." + i + "_src";
                    $(imageinput).attr("src", attachment.url);
                    $("." + i).attr("value", attachment.id);
                } else {
                    alert("could not add");
                }
            }
    ...
    try {
        ...
        console.log("view is not present right now");
    }
...
jQuery(document).ready(function ($) {
    ...
    $('a#upload').bind("click", function () {
        ...
        if (file_data) {
            ...
            $.ajax({
                url: pathname + 'wp-content/themes/cecp/lib/ajax_php_file.php', // point to server-side PHP script 
                ...
                success: function (data) {
                    if (data == "invalid file") {
                        alert('Please Selet a valid file xlsx,cad, pdf, doc, docx, ppt, pptx, pps, ppsx, odt, xls, xlsx');
                        return false;
                    } else {
                        $('#document-url-hidden').val(data);
    ...
    $('a#unload').bind("click", function () {
        $('#document-url-hidden').val('');
        var pathname = window.location.protocol + "//" + window.location.host + "/"
        var filename = $(this).attr('data-file');
        $.ajax({
            type: 'POST',
            url: pathname + 'wp-content/themes/cecp/lib/delete_php_file.php',
        ...
        return function () {
            if (!b || !b.requirejs) {
                ...
                !function (b) {
                    ...
                    function q(a, b) {
                        var c, d, e, f, g, h, i, j, l, m, n, p = b && b.split("/"), q = k.map, r = q && q["*"] || {};
                        if (a && "." === a.charAt(0))
                            if (b) {
                                for (a = a.split("/"), g = a.length - 1, k.nodeIdCompat && o.test(a[g]) && (a[g] = a[g].replace(o, "")), a = p.slice(0, p.length - 1).concat(a), l = 0; l < a.length; l += 1)
                                    if (n = a[l], "." === n)
                                        a.splice(l, 1), l -= 1;
                                    else if (".." === n) {
                                        if (1 === l && (".." === a[2] || ".." === a[0]))
                                            break;
                                        l > 0 && (a.splice(l - 1, 2), l -= 2)
                                    }
                                a = a.join("/")
                            } else
                                0 === a.indexOf("./") && (a = a.substring(2));
                        if ((p || r) && q) {
                            for (c = a.split("/"), l = c.length; l > 0; l -= 1) {
                                if (d = c.slice(0, l).join("/"), p)
                                    for (m = p.length; m > 0; m -= 1)
                                        if (e = q[p.slice(0, m).join("/")], e && (e = e[d])) {
                                            f = e, h = l;
                                            break
                                        }
                                if (f)
                    ...
                    function r(a, c) {
                        return function () {
                            ...
                            return"string" != typeof d[0] && 1 === d.length && d.push(null), f.apply(b, d.concat([a, c]))
                        }
                    }
                    function s(a) {
                        return function (b) {
                    ...
                    var e, f, g, h, i = {}, j = {}, k = {}, l = {}, m = Object.prototype.hasOwnProperty, n = [].slice, o = /\.js$/;
                    g = function (a, b) {
                        var c, d = v(a), e = d[0];
                        return a = d[1], e && (e = q(e, b), c = u(e)), e ? a = c && c.normalize ? c.normalize(a, s(b)) : q(a, b) : (a = q(a, b), d = v(a), e = d[0], a = d[1], e && (c = u(e))), {f: e ? e + "!" + a : a, n: a, pr: e, p: c}
                            ...
                            return{id: a, uri: "", exports: i[a], config: w(a)}
                        }}, e = function (a, c, d, e) {
                        var f, k, m, n, o, v, q = [], s = typeof d;
                        if (e = e || a, "undefined" === s || "function" === s) {
                            for (c = !c.length && d.length?["require", "exports", "module"]:c, o = 0; o < c.length; o += 1)
                                if (n = g(c[o], e), k = n.f, "require" === k)
                                    q[o] = h.require(a);
                                else if ("exports" === k)
                                    q[o] = h.exports(a), v = !0;
                                else if ("module" === k)
                                    f = q[o] = h.module(a);
                                else if (p(i, k) || p(j, k) || p(l, k))
                                    q[o] = u(k);
                                else {
                                    if (!n.p)
                                        throw new Error(a + " missing " + k);
                                    n.p.load(n.n, r(e, !0), t(k), {}), q[o] = i[k]
                                }
                            m = d ? d.apply(i[a], q) : void 0, a && (f && f.exports !== b && f.exports !== i[a] ? i[a] = f.exports : m === b && v || (i[a] = m))
                        } else
                            a && (i[a] = d)
                    }, a = c = f = function (a, c, d, i, j) {
                        if ("string" == typeof a)
                            return h[a] ? h[a](c) : u(g(a, c).f);
                        if (!a.splice) {
                            if (k = a, k.deps && f(k.deps, k.callback), !c)
                                return;
                            c.splice ? (a = c, c = d, d = null) : a = b
                        }
                        return c = c || function () {
                        }, "function" == typeof d && (d = i, i = j), i ? e(b, a, c, d) : setTimeout(function () {
                            e(b, a, c, d)
                        }, 4), f
                    }, f.config = function (a) {
                        return f(a)
                    }, a._defined = i, d = function (a, b, c) {
                        if ("string" != typeof a)
                            throw new Error("See almond README: incorrect module build, no module name");
                        b.splice || (c = b, b = []), p(i, a) || p(j, a) || (j[a] = [a, b, c])
                    }, d.amd = {jQuery: !0}
            ...
            b.Extend = function (a, b) {
                ...
                function f() {
                    var c = Array.prototype.unshift, d = b.prototype.constructor.length, e = a.prototype.constructor;
                    d > 0 && (c.call(arguments, a.prototype.constructor), e = b.prototype.constructor), e.apply(this, arguments)
                }
                function g() {
                    this.constructor = f
                }
                var d = c(b), e = c(a);
                b.displayName = a.displayName, f.prototype = new g;
                for (var h = 0; h < e.length; h++) {
                    var i = e[h];
                    f.prototype[i] = a.prototype[i]
                }
                for (var j = (function (a) {
                    ...
                    return function () {
                        ...
                        return a.call(arguments, c), d.apply(this, arguments)
                    }
                }), k = 0; k < d.length; k++) {
                    var l = d[k];
                    f.prototype[l] = j(l)
            ...
            return b.Extend(d, b.Observable), d.prototype.render = function () {
                ...
                var d = this, f = (a.id + "-container", a.id + "-results");
                this.container = a, this.$selection.on("focus", function (a) {
                    ...
                    d.$selection.attr("aria-expanded", "true"), d.$selection.attr("aria-owns", f), d._attachCloseHandler(a)
                }), a.on("close", function () {
            ...
            return b.Extend(d, a), d.prototype.select = function (a) {
                ...
                }).get(), g = [], i = 0; i < a.length; i++) {
                    var j = this._normalizeItem(a[i]);
                    if (c.inArray(j.id, f) >= 0) {
                        var k = e.filter(h(j)), l = this.item(k), m = c.extend(!0, {}, j, l), n = this.option(m);
                        k.replaceWith(n)
                    } else {
                        var o = this.option(j);
                        if (j.children) {
            ...
            return b.Extend(d, a), d.prototype._applyDefaults = function (a) {
                ...
                "function" == typeof f.url && (f.url = f.url.call(this.$element, a)), "function" == typeof f.data && (f.data = f.data.call(this.$element, a)), this.ajaxOptions.delay && null != a.term ? (this._queryTimeout && window.clearTimeout(this._queryTimeout), this._queryTimeout = window.setTimeout(g, this.ajaxOptions.delay)) : g()
            }, d
            ...
            return b.prototype.query = function (a, b, c) {
                function e(a, f) {
                    for (var g = a.results, h = 0; h < g.length; h++) {
                        var i = g[h], j = null != i.children && !e({results: i.children}, !0), k = i.text === b.term;
                        if (k || j)
                    ...
                    if (null != l) {
                        var m = d.option(l);
                        m.attr("data-select2-tag", !0), d.addOptions([m]), d.insertTag(g, l)
                    }
                    a.results = g, c(a)
                }
                var d = this;
                return this._removeOldTags(), null == b.term || null != b.page ? void a.call(this, b, c) : void a.call(this, b, e)
                ...
                var d = (this._lastTag, this.$element.find("option[data-select2-tag]"));
                d.each(function () {
            ...
            return b.prototype.bind = function (a, b, c) {
                ...
                function f(b) {
                    var c = e._normalizeItem(b), d = e.$element.find("option").filter(function () {
                        return a(this).val() === c.id
                    });
                    if (!d.length) {
                        var f = e.option(c);
                        f.attr("data-select2-tag", !0), e._removeOldTags(), e.addOptions([f])
                    }
                    g(c)
                }
                function g(a) {
                ...
                var e = this;
                c.term = c.term || "";
                var h = this.tokenizer(c, this.options, f);
